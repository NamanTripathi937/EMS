...
const Register = () => {
  ...
  return (
    <>
      <div >
        {loading && <Spinner />}
        <h1 className="register-head">MONEY MATRIX <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-wallet2" viewBox="0 0 16 16">
